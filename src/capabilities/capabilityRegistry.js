...
const overrides = [
  ...
  base("CONTENT_BRIEF", {
    description: "Resolve a human production goal into an execution-grade content brief without calling providers.",
    domainTags: ["production", "content_intelligence", "workflow"],
    inputTypes: ["ProductionGoal", "ProductionIntent"],
    outputTypes: ["ContentBrief"],
    requiredSubCapabilities: ["CONTENT_PLAN", "SEMANTIC_ANALYZE"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("SCRIPT_GENERATE", {
    description: "Prepare a scripted production artifact from an approved brief; live model execution remains gated.",
    domainTags: ["production", "workflow"],
    inputTypes: ["ContentBrief"],
    outputTypes: ["ScriptArtifact"],
    requiredSubCapabilities: ["TEXT_GENERATE", "TEXT_EDIT"],
    externalProviderPossible: true,
    riskClass: capabilityRiskClasses.medium,
    costClass: capabilityCostClasses.metered,
  ...
  base("SCRIPT_QUALITY_REVIEW", {
    description: "Review script quality, meaning preservation and Lisa production fit before rendering.",
    domainTags: ["production", "workflow"],
    inputTypes: ["ScriptArtifact"],
    outputTypes: ["QualityGate"],
    requiredSubCapabilities: ["SEMANTIC_ANALYZE"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
  ...
  base("AVATAR_RENDER", {
    description: "Render avatar/video presence after identity rights, provider boundary and human approval are satisfied.",
    domainTags: ["production", "identity", "workflow"],
    inputTypes: ["ScriptArtifact", "IdentityRightsState"],
    outputTypes: ["AvatarArtifact"],
    requiredSubCapabilities: ["VIDEO_GENERATE"],
    externalProviderPossible: true,
    riskClass: capabilityRiskClasses.high,
    costClass: capabilityCostClasses.paidExternal,
    approvalRequirements: ["human_approval", "identity_rights_approval", "provider_activation_approval"],
    activationState: capabilityActivationStates.architectureOnly
  }),
  base("MASTER_ASSEMBLE", {
    description: "Assemble voice and visual provider outputs into an immutable master content artifact.",
    domainTags: ["production", "workflow"],
    inputTypes: ["VoiceArtifact", "AvatarArtifact"],
    outputTypes: ["MasterContentArtifact"],
    requiredSubCapabilities: ["VIDEO_COMPOSE", "AUDIO_MIX"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("MASTER_VERIFY", {
    description: "Verify master artifact completeness, lineage, audio, visual and Lisa production requirements.",
    domainTags: ["production", "workflow"],
    inputTypes: ["MasterContentArtifact"],
    outputTypes: ["MasterVerification"],
    requiredSubCapabilities: ["VIDEO_ANALYZE", "AUDIO_ANALYZE"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("SEMANTIC_CLIP_PLAN", {
    description: "Plan meaning-first short-form moments from a verified master without cutting or publishing.",
    domainTags: ["production", "content_intelligence", "workflow"],
    inputTypes: ["MasterVerification"],
    outputTypes: ["SemanticClipPlan"],
    requiredSubCapabilities: ["CONTENT_ANALYZE", "SEMANTIC_ANALYZE"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("SHORT_FORM_DERIVATIVES", {
    description: "Prepare planned short-form derivative artifacts and ContentVariant lineage from a semantic clip plan.",
    domainTags: ["production", "content_intelligence", "workflow"],
    inputTypes: ["SemanticClipPlan"],
    outputTypes: ["ShortFormDerivativeSet", "ContentVariant"],
    requiredSubCapabilities: ["VIDEO_TRIM", "VIDEO_RESIZE", "VIDEO_CAPTION", "CONTENT_EXPERIMENT"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("SHORT_FORM_QUALITY_REVIEW", {
    description: "Review derivative quality, platform readiness and master lineage before any distribution decision.",
    domainTags: ["production", "content_intelligence", "workflow"],
    inputTypes: ["ShortFormDerivativeSet"],
    outputTypes: ["QualityGate"],
    requiredSubCapabilities: ["CONTENT_ANALYZE", "CONTENT_LEARN"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.localCompute,
  ...
  base("HUMAN_REVIEW_CHECKPOINT", {
    description: "Gate production artifacts behind scoped human review before provider activation or publishing.",
    domainTags: ["production", "approval", "workflow"],
    inputTypes: ["QualityGate", "ProductionApprovalScope"],
    outputTypes: ["HumanReviewCheckpoint"],
    deterministicPossible: true,
    localPossible: true,
    externalProviderPossible: false,
    costClass: capabilityCostClasses.free,
